...
const Demo = () => (
  <div>
    ...
    <Gist className="hello" url='https://gist.github.com/GeorgeGkas/5f55a83909a3f5b766934ffe802d30df#file-start-js' LoadingComponent={() => <strong>Custom loading component...</strong>} />
    ...
    <Gist className="hello" url='https://gist.github.com/GeorgeGkas/5f55a83909a3f5b766934ffe802d30df#file-start-js' LoadingComponent={() => <strong>Custom loading component...</strong>} />
    <Gist className="hello" url='https://gist.github.com/GeorgeGkas/5f55a83909a3f5b766934ffe802d30df#file-multiple-js' LoadingComponent={() => <strong>Custom loading component...</strong>} />
    ...
    <Gist className="hello" url='https://gist.github.com/GeorgeGkas/5f55a83909a3f5b766934ffe802d30df' file='CaMelCase.js' LoadingComponent={() => <strong>Custom loading component...</strong>} />
    <h2>Render the whole Gist</h2>
    <p>Of course, we can also embed the whole Gist repository just by copying the Gist URL.</p>
    <Gist className="hello" url='https://gist.github.com/GeorgeGkas/5f55a83909a3f5b766934ffe802d30df' LoadingComponent={() => <strong>Custom loading component...</strong>} />
    
    <h2>Error Component</h2>
    <p>Render a custom error component if Gist could not be retrieved.</p>
    <Gist className="hello" url='https://gist.github.com/GeorgeGkas/5f55a83909a3f5b7tyjty66934ffedd802d30df#file-multiple-js' LoadingComponent={() => <strong>Custom loading component...</strong>} ErrorComponent={() => <strong>Gist failed to load.</strong>} />
